...
/**
 * Renders a sidebar component with navigation links.
 *
...
const SideBar: React.FC = () => {
  ...
  return (
    <div
      className={`border-2 min-h-screen max-h-full md:col-span-1 bg-[#03001C] py-4 border-none md:translate-x-0 md:z-0 md:w-full
